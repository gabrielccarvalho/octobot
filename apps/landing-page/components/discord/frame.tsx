 ...
 */
export function DiscordFrame({ children }: { children: React.ReactNode }) {
  return (
    <div
    ...
    >
      {/* Server rail */}
      <div className="flex w-[52px] shrink-0 flex-col items-center gap-2 bg-[#1e1f22] py-3" aria-hidden>
